...
## Задачи по улучшению графика

### Приоритетные задачи
1. Вынести лимит баров (сейчас 10000) в админскую панель для настройки
2. Убрать скролл снизу графика, оставить только внутренний зум

### Улучшения UI/UX
1. Добавить настройки цветов свечей в админской панели
2. Добавить возможность настройки отображения шкалы цен (слева/справа)
3. Добавить настройку формата отображения времени на оси X
4. Добавить настройку отображения сетки графика
5. Добавить настройку отображения легенды
