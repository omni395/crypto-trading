...
[
  {
    ...
    chart_url: 'https://api.binance.com/api/v3/klines?symbol= {symbol}',
    status: 'active',
  ...
  },
  {
    ...
    api_url: 'https://fapi.binance.com/fapi/v1/ticker/24hr?symbol=%{symbol}',
    batch_api_url: 'https://fapi.binance.com/fapi/v1/ticker/24hr?symbols=[%{symbols}]',
    chart_url: 'https://fapi.binance.com/fapi/v1/klines?symbol={symbol}',
    status: 'active',
